...
object NativeLoader {
    ...
    external fun detectBalls(pixelData: ByteArray, width: Int, height: Int, stride: Int, mode: Int): FloatArray?
    external fun setHomography(matrix: FloatArray)
    external fun perspectiveTransform(src: FloatArray): FloatArray?
    external fun calcAim(cueX: Float, cueY: Float, targetX: Float, targetY: Float, pocketX: Float, pocketY: Float, maxBanks: Int): FloatArray?
}
